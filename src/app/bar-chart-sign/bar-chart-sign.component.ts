...
@Component({
  selector: 'app-bar-chart-sign',
  templateUrl: './bar-chart-sign.component.html',
  styleUrls: ['./bar-chart-sign.component.scss']
})
export class BarChartSignComponent implements OnInit {
  @Input() query: Object;
